...
logit.debug('logging after first creation')
...
# logging_dct = config['api_log_parameters']
...
WM = weatherman.WeatherMan(logger, logit)
validator = data_validator.DataValidator()
SW = setup_weatherman.SetupWeatherman()
logit.debug('logging after seccond creation')
